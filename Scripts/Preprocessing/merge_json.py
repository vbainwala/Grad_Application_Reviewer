...
def merge_json_files():
    merged_data = []
    folder = Path("/Users/vareeshbainwala/Documents/Grad_Application_Reviewer/Processed_Json")
    ...
    with open('/Users/vareeshbainwala/Documents/Grad_Application_Reviewer/json_documents/input_document_docetl.json', 'w') as outfile:
